...
var amount_category_controller_get_exports = {};
__export(amount_category_controller_get_exports, {
  AmountCategoryControllerGetTest: () => AmountCategoryControllerGetTest
});
module.exports = __toCommonJS(amount_category_controller_get_exports);
...
0 && (module.exports = {
  AmountCategoryControllerGetTest
});
