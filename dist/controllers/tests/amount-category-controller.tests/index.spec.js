...
// src/controllers/tests/amount-category-controller.tests/index.spec.ts
...
// src/controllers/tests/amount-category-controller.tests/amount-category-controller-create.ts
function AmountCategoryControllerCreateTest(serverInstance) {
  ...
  describe("create", () => {
    test("must pass", () => __async(this, null, function* () {
      ...
      globalExpect(serverInstance.getResponse.header).toStrictEqual(["location", "/amount-category/test"]);
...
// src/controllers/tests/amount-category-controller.tests/amount-category-controller-get.ts
function AmountCategoryControllerGetTest(serverInstance) {
  const createdAt = /* @__PURE__ */ new Date();
  const unusedUsecase = null;
  const usecase = {
    execute: () => {
...
// src/controllers/tests/amount-category-controller.tests/amount-category-controller-delete.ts
function AmountCategoryControllerDeleteTest(serverInstance) {
  const unusedUsecase = null;
  const usecase = {
    execute() {
      return Promise.resolve();
