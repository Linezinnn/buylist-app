...
// src/controllers/tests/item-category-controller.tests/index.spec.ts
...
// src/controllers/tests/item-category-controller.tests/item-category-controller-create.ts
function ItemCategoryControllerCreateTest(serverInstance) {
  ...
  describe("create", () => {
    test("must pass", () => __async(this, null, function* () {
      ...
      globalExpect(serverInstance.getResponse.header).toStrictEqual(["location", "/item-category/test"]);
      globalExpect(serverInstance.getResponse.send).toStrictEqual({
        name: "test",
        color: "#fff",
        id: "test",
        createdAt
...
// src/controllers/tests/item-category-controller.tests/item-category-controller-get-all.ts
function ItemCategoryControllerGetAllTest(serverInstance) {
  const createdAt = /* @__PURE__ */ new Date();
  const unusedUsecase = null;
  const usecase = {
    execute: () => {
...
// src/controllers/tests/item-category-controller.tests/item-category-controller-delete.ts
function ItemCategoryControllerDeleteTest(serverInstance) {
  const unusedUsecase = null;
  const usecase = {
    execute() {
      return Promise.resolve();
...
// src/controllers/tests/item-category-controller.tests/item-category-controller-get-by-id.ts
function ItemCategoryControllerGetByIdTest(serverInstance) {
  const createdAt = /* @__PURE__ */ new Date();
  const unusedUsecase = null;
  const usecase = {
    execute: () => {
