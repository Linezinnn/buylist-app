...
var item_category_controller_delete_exports = {};
__export(item_category_controller_delete_exports, {
  ItemCategoryControllerDeleteTest: () => ItemCategoryControllerDeleteTest
});
module.exports = __toCommonJS(item_category_controller_delete_exports);
...
0 && (module.exports = {
  ItemCategoryControllerDeleteTest
});
