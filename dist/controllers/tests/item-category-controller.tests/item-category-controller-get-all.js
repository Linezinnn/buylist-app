...
var item_category_controller_get_all_exports = {};
__export(item_category_controller_get_all_exports, {
  ItemCategoryControllerGetAllTest: () => ItemCategoryControllerGetAllTest
});
module.exports = __toCommonJS(item_category_controller_get_all_exports);
...
0 && (module.exports = {
  ItemCategoryControllerGetAllTest
});
