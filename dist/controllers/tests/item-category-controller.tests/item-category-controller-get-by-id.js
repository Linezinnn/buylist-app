...
var item_category_controller_get_by_id_exports = {};
__export(item_category_controller_get_by_id_exports, {
  ItemCategoryControllerGetByIdTest: () => ItemCategoryControllerGetByIdTest
});
module.exports = __toCommonJS(item_category_controller_get_by_id_exports);
...
0 && (module.exports = {
  ItemCategoryControllerGetByIdTest
});
