...
// src/controllers/tests/item-controller.tests/index.spec.ts
...
// src/controllers/tests/item-controller.tests/item-controller-create.ts
...
// src/controllers/tests/item-controller.tests/item-controller-create.ts
function ItemControllerCreateTest(serverInstance) {
  ...
  describe("create", () => {
    test("must pass", () => __async(this, null, function* () {
      const usecaseClone = __spreadValues({}, usecase);
      ...
      yield controller.create(serverInstance.request, serverInstance.response);
      globalExpect(serverInstance.getResponse.status).toBe(201);
      globalExpect(serverInstance.getResponse.header).toStrictEqual(["location", "/item/test"]);
      globalExpect(serverInstance.getResponse.send).toStrictEqual(itemMock);
    }));
    test("with an error, should handle it", () => {
      let usecaseClone = __spreadValues({}, usecase);
      ...
      globalExpect(() => __async(this, null, function* () {
        yield controller.create(serverInstance.request, serverInstance.response);
        globalExpect(serverInstance.getResponse.status).toEqual(400);
      })).not.toThrow();
    });
    test("with an unxpect error, should handle it", () => {
      ...
      globalExpect(() => __async(this, null, function* () {
        yield controller.create(serverInstance.request, serverInstance.response);
        globalExpect(serverInstance.getResponse.status).toEqual(500);
      })).not.toThrow();
    });
  });
}

// src/controllers/tests/item-controller.tests/item-controller-get-by-id.ts
var import_crypto2 = require("crypto");
function ItemControllerGetByIdTest(serverInstance) {
  const date = /* @__PURE__ */ new Date();
  ...
  describe("get by id", () => {
    test("must pass", () => __async(this, null, function* () {
      ...
      yield controller.getById(serverInstance.request, serverInstance.response);
      globalExpect(serverInstance.getResponse.status).toBe(200);
      globalExpect(serverInstance.getResponse.send).toStrictEqual(itemMock);
    }));
    test("with an error, should handle it", () => {
      let usecaseClone = __spreadValues({}, usecase);
...
// src/controllers/tests/item-controller.tests/item-controller-get-all.ts
var import_crypto3 = require("crypto");
function ItemControllerGetAllTest(serverInstance) {
  const date = /* @__PURE__ */ new Date();
  const unusedUsecase = null;
  ...
  describe("get all", () => {
    test("must pass", () => __async(this, null, function* () {
      ...
      yield controller.getAll(serverInstance.response);
      globalExpect(serverInstance.getResponse.status).toBe(200);
      globalExpect(serverInstance.getResponse.send).toStrictEqual([itemMock]);
    }));
    test("with an error, should handle it", () => {
...
// src/controllers/tests/item-controller.tests/item-controller-delete.ts
function ItemControllerDeleteTest(serverInstance) {
  const unusedUsecase = null;
  const usecase = {
    execute() {
  ...
  describe("delete", () => {
    test("must pass", () => {
      ...
      serverInstance.request.params = { id: "id_test" };
      globalExpect(() => __async(this, null, function* () {
        yield controller.delete(serverInstance.request, serverInstance.response);
        globalExpect(serverInstance.getResponse.status).toBe(204);
      })).not.toThrow();
    });
    ...
    test("With an error, should handle it", () => {
      ...
      globalExpect(() => __async(this, null, function* () {
        yield controller.delete(serverInstance.request, serverInstance.response);
        globalExpect(serverInstance.getResponse.status).toBe(400);
      })).not.toThrow();
    });
    test("With an unxpect error, should handle it", () => {
      let usecaseClone = __spreadValues({}, usecase);
      ...
      globalExpect(() => __async(this, null, function* () {
        yield controller.delete(serverInstance.request, serverInstance.response);
        globalExpect(serverInstance.getResponse.status).toBe(500);
      })).not.toThrow();
    });
  });
}

// src/controllers/tests/item-controller.tests/item-controller-check.ts
var import_crypto4 = require("crypto");
function ItemControllerCheckTest(serverInstance) {
  const date = /* @__PURE__ */ new Date();
  const unusedUsecase = null;
  const uuid = (0, import_crypto4.randomUUID)();
  const itemMock = {
    name: "TESTE",
    amount: 200,
    isChecked: true,
  ...
  describe("check item", () => {
    test("must pass", () => __async(this, null, function* () {
      ...
      yield controller.checkItem(serverInstance.request, serverInstance.response);
      globalExpect(serverInstance.getResponse.status).toBe(200);
      globalExpect(serverInstance.getResponse.send).toStrictEqual(itemMock);
    }));
    test("with an error, should handle it", () => {
...
var ServerInstance = class {
  constructor() {
    ...
    this.response = {
      ...
      status: (statusCode2) => {
        this.getResponse.status = statusCode2;
        return this.response;
      }
    };
  }
