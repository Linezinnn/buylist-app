...
var item_controller_check_exports = {};
__export(item_controller_check_exports, {
  ItemControllerCheckTest: () => ItemControllerCheckTest
});
module.exports = __toCommonJS(item_controller_check_exports);
