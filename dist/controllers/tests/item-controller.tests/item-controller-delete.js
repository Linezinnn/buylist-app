...
var item_controller_delete_exports = {};
__export(item_controller_delete_exports, {
  ItemControllerDeleteTest: () => ItemControllerDeleteTest
});
module.exports = __toCommonJS(item_controller_delete_exports);
