...
var item_controller_get_all_exports = {};
__export(item_controller_get_all_exports, {
  ItemControllerGetAllTest: () => ItemControllerGetAllTest
});
module.exports = __toCommonJS(item_controller_get_all_exports);
