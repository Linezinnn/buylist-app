...
var item_controller_get_by_id_exports = {};
__export(item_controller_get_by_id_exports, {
  ItemControllerGetByIdTest: () => ItemControllerGetByIdTest
});
module.exports = __toCommonJS(item_controller_get_by_id_exports);
