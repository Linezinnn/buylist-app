...
describe("up error", () => {
  test("must be a valid error", () => {
    ...
    globalExpect(error).toHaveProperty("error", { details: "Test" });
    globalExpect(error).toHaveProperty("statusCode", 400);
    globalExpect(error).toHaveProperty("message", "Test");
  });
  ...
  test("must be possible throw an error without status code and error details", () => {
    ...
    globalExpect(error).toHaveProperty("message", "Test");
    globalExpect(error).toHaveProperty("error", void 0);
    globalExpect(error).toHaveProperty("statusCode", void 0);
  });
});
