...
// src/usecases/amount-category/create-amount-category-usecase.spec.ts
...
describe("create amount category usecase", () => {
  ...
  test("must pass", () => __async(exports, null, function* () {
    ...
    const result = yield usecase.execute({ name: "test" });
  ...
  test("cannot pass if name already exists", () => {
    ...
    globalExpect(() => __async(exports, null, function* () {
      yield usecase.execute({ name: "test" });
  ...
  test("cannot pass because name contains numbers", () => {
    ...
    globalExpect(() => __async(exports, null, function* () {
      try {
        yield usecase.execute({ name: "test2" });
      } catch (error) {
        if (error instanceof UpError) {
          globalExpect(error.message).toBe("The name must not contain a number in the string");
        }
        throw "test pass";
      }
  ...
  test("cannot pass because it has less than 1 character", () => {
    ...
    globalExpect(() => __async(exports, null, function* () {
      try {
        yield usecase.execute({ name: "" });
      } catch (error) {
        if (error instanceof UpError) {
          globalExpect(error.message).toBe("The minimum name length is 1");
        }
        throw "test pass";
      }
    })).rejects.toThrow("test pass");
  ...
  test("cannot pass because it has more than 6 character", () => {
    ...
    globalExpect(() => __async(exports, null, function* () {
      try {
        yield usecase.execute({ name: "this_number_is_long" });
      } catch (error) {
        if (error instanceof UpError) {
          globalExpect(error.message).toBe("The maximum name length is 6");
        }
        throw "test pass";
      }
    })).rejects.toThrow("test pass");
