...
// src/utils/validations/schemas/amount-category-schema.test/amount-category-dto-schema.ts
...
// src/utils/validations/schemas/amount-category-schema.test/amount-category-dto-schema.ts
function TESTAmountCategoryDTOSchema() {
  ...
  describe("amount category dto schema", () => {
    test("validation needs to pass", () => {
      ...
      globalExpect(validatedData).toHaveProperty("name", "teste");
      ...
      globalExpect(() => {
        try {
          ...
          if (error instanceof import_zod2.ZodError) {
            ...
            globalExpect(message).toEqual("The name must not contain a number in the string");
            throw "test pass";
          }
        }
      }).toThrow("test pass");
    ...
    test("cannot pass because name is less than 1 character", () => {
      ...
      globalExpect(() => {
        try {
          ...
          if (error instanceof import_zod2.ZodError) {
            const { message } = error.issues[0];
            globalExpect(message).toEqual("The minimum name length is 1");
            throw "test pass";
          }
        }
      }).toThrow("test pass");
    ...
    test("cannot pass because name has more than 1 character", () => {
      ...
      globalExpect(() => {
        try {
          ...
          if (error instanceof import_zod2.ZodError) {
            const { message } = error.issues[0];
            globalExpect(message).toEqual("The maximum name length is 6");
            throw "test pass";
          }
        }
      }).toThrow("test pass");
    ...
    test("must have at least a name", () => {
      ...
      const validatedData = AmountCategoryDTOSchema.parse(testData2);
      globalExpect(validatedData).toHaveProperty("name", "teste");
    });
...
// src/utils/validations/schemas/amount-category-schema.test/amount-category-response-schema.ts
var import_zod3 = require("zod");
var import_crypto2 = require("crypto");
function TESTAmountCategoryResponseSchema() {
  ...
  describe("amount category response schema", () => {
    ...
    test("cannot pass because it does not have an id", () => {
      ...
      globalExpect(() => {
        try {
          AmountCategoryResponseSchema.parse(testData2);
        } catch (error) {
          if (error instanceof import_zod3.ZodError) {
            const { message } = error.issues[0];
            globalExpect(message).toEqual("Required");
            throw "test pass";
          }
        }
      }).toThrow("test pass");
    ...
    test("cannot pass because it does not have a valid date", () => {
      let testDataClone = __spreadValues({}, testData);
      testDataClone.createdAt = "any_value";
      globalExpect(() => {
        try {
          AmountCategoryResponseSchema.parse(testDataClone);
        } catch (error) {
          if (error instanceof import_zod3.ZodError) {
            const { message } = error.issues[0];
            globalExpect(message).toEqual("Expected date, received string");
            throw "test pass";
          }
        }
      }).toThrow("test pass");
...
// src/utils/validations/schemas/amount-category-schema.test/index.spec.ts
