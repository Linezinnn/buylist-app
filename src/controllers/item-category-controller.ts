...
import { ICreateItemCategoryUseCase, IDeleteItemCategoryUseCase, IGetAllItemCategoriesUseCase } from "../usecases/item-category/interfaces/item-category-usecase-interfaces";
